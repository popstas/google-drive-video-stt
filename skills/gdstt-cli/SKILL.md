...
**Кандидаты для определения спикеров** тоже берутся отсюда: модели отдаются те, кто
реально говорил, а не имена, вытащенные регулярками из документа Meet. Промолчавший
участник кандидатом не предлагается - он не может быть одним из голосов. Сам документ
по-прежнему читается, его реплики идут модели как улика. Определять спикеров по
