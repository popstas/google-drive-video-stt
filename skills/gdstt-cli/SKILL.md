...
папке сотрудника три встречи из одиннадцати были только ярлыками, и ни один не
открывался аккаунтом, которому расшарили папку. `doctor --drive` называет, сколько
таких звонков папка не обработает - их берут из папки организатора.
