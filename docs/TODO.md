...
- [ ] настроить исключения, где запускать обработку. Пример: mp4 с названием, начинающимся на `Sale department B2B` — нужно всегда распознавать и отправлять в тестовую задачу
